...
const datatableHeaders = [
  ...
  { text: 'Order Leadtime Days', value: 'order_leadtime_days', minWidth: '100px' },
  { text: 'Stock Out Forecast Days', value: 'stock_out_forecast_days', minWidth: '100px' },
  { text: 'Target Inv Turnover Days', value: 'target_inv_turnover_days', minWidth: '100px' },
