          ...
          <div class="border rounded p-3 mb-4 bg-white">
            ...
            <table class="table table-bordered table-sm table-hover" style="min-width: 2000px;">
                ...
                <tr>
                    ...
                    <th style="min-width: 120px;">6-Month Avg Usage</th>
                    <th style="min-width: 120px;">Last Month Usage</th>
                    <th style="min-width: 120px;">Stock Beginning</th>
                    <th style="min-width: 120px;">Order Plan Qty</th>
                    <th style="min-width: 120px;">Demand Forecast</th>
                    <th style="min-width: 120px;">Stock Ending</th>
                    <th style="min-width: 140px;">Ending Stock Cover Day</th>
                    <th style="min-width: 140px;">Target Safety Stock Day</th>
                    <th style="min-width: 120px;">Stock Value</th>
                    <th style="min-width: 140px;">Inventory Reorder Qty</th>
                    <th style="min-width: 140px;">Reorder Level Qty</th>
                    <th style="min-width: 160px;">Max Inventory Level Qty</th>
                    <th style="min-width: 140px;">Max Inventory Usage Day</th>
